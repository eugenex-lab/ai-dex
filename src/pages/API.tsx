  ...
  return (
    <div className="container mx-auto pt-24 pb-12 max-w-4xl">
      ...
      <p className="text-center text-lg mb-12 text-muted-foreground">
        We are excited to offer developers, traders, and businesses the
        opportunity to integrate with Tradenly's powerful trading platform. By
        signing up for early access, you'll be among the first to leverage our
        APIs when they launch.
      </p>
