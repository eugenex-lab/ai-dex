  ...
  const steps = [
    {
      ...
      title: "Select Tokens",
      description:
        "Choose the token you want to spend and the token you want to arbitrage",
    },
    {
      number: 2,
      title: "Set Parameters",
      description:
        "Define your desired percentage gain and the amount you want to trade",
    },
    {
      number: 3,
      title: "Choose Sources",
      description:
        "Select the DEX sources you want to monitor for opportunities",
    },
    {
      number: 4,
      title: "Connect & Trade",
      description:
        "Connect your wallet and start trading when opportunities arise",
    },
  ];
