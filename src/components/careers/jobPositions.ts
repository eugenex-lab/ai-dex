...
export const jobPositions: JobPosition[] = [
  ...
  },
  {
    ...
    requirements: [
      ...
      "Experience with AI model training, fine-tuning, and optimization",
      "Strong understanding of time-series forecasting, quantitative analysis, and financial modeling",
      "Knowledge of big data frameworks (Spark, Dask) and cloud computing (AWS, GCP, Azure)",
      "Familiarity with blockchain data analysis and decentralized finance (DeFi) trends",
      "Experience working with real-time data pipelines and API integrations"
    ],
    role: [
      "Develop and train AI models for market prediction, risk management, and automated trading strategies",
      "Integrate machine learning algorithms into Tradenly's trading bots and analytics tools",
      "Scale and optimize existing AI infrastructure for faster and more efficient performance",
      "Collaborate with developers to deploy AI solutions within a high-performance trading environment",
      "Research and implement cutting-edge AI advancements in crypto trading and financial markets"
    ]
  }
];
