      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl w-full">
        ...
        >
          <div className="w-full max-w-[400px] aspect-square">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 md:-translate-x-[48px] xl:translate-x-[28px] lg:-translate-x-[20px] -translate-y-1/2 text-center">
